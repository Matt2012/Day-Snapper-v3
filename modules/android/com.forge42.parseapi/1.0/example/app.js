...
var window = Ti.UI.createWindow({
	...
	//navBarHidden: true // don't use this because on android, there are problems with openPhotoGallery. See workarounds here: http://jira.appcelerator.org/browse/TIMOB-1595
});
...
if (Titanium.Platform.name == 'android') 
{
	...
	// If you don't have a facebook application id, just use this
	// parseapi.initParse( {
	// 						applicationId: "Place your Application Id Here",
	// 						clientKey: "Place your Client Key Here"
	// 					});
...
// Since the Current PFUser is cached, let's refresh the user upon application resume
if (Titanium.Platform.name == 'android') 
{
